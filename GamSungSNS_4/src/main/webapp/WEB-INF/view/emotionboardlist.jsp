						...
						<div class="col col-sm-6">
							...
							<div class="container">
								...
								<p>The .thumbnail class can be used to display an image
									gallery. Click on the images to see it in full size:</p>
								<div class="row">
									<div class="col-md-3">
										<a href="pulpitrock.jpg" class="thumbnail">
											<p>본문의 내용에서 보여주는 글자수는 노트북은 20글자</p> <img src="pulpitrock.jpg"
											alt="Pulpit Rock" style="width: 150px; height: 150px">
										</a>
									</div>
									<div class="col-md-3">
										<a href="moustiers-sainte-marie.jpg" class="thumbnail">
											<p>데스크탑1200px 이상부터는 30글자까지 표시</p> <img
											src="moustiers-sainte-marie.jpg" alt="Moustiers Sainte Marie"
											style="width: 150px; height: 150px">
										</a>
									</div>
									<div class="col-md-3">
										<a href="cinqueterre.jpg" class="thumbnail">
											<p>게시물 내용을 출력할 것이며 기본적으로 본문의 내용과 사진</p> <img
											src="cinqueterre.jpg" alt="Cinque Terre"
											style="width: 150px; height: 150px">
										</a>
									</div>
								</div>
